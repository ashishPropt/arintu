...
const DEFAULT_FAQ = {
  items: [
    ...
    {
      q: 'How do I sign up for a class? (Step by step)',
      a: `Here's the full path from browsing a class to attending your first session:
    ...
    <div className="border border-gray-100 rounded-xl overflow-hidden">
      ...
      {open && (
        <div className="px-5 pb-4 bg-white">
          <p className="text-sm text-gray-600 leading-relaxed border-t border-gray-50 pt-3 whitespace-pre-line">{a}</p>
        </div>
      )}
    </div>
  );
