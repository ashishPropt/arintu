...
const navByRole = {
  superadmin: [
    ...
    { to: '/app/pending-accounts', label: 'Teacher/Admin Approvals', icon: PendingIcon },
    ...
    <>
      ...
      <aside
        className={`
          ...
          w-64 sm:w-56 shrink-0 flex flex-col bg-white border-r border-gray-100 h-screen
          transition-transform duration-200
          ${mobileOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}
        `}
      >
        <div className="px-5 py-5 border-b border-gray-100 flex items-center justify-between">
          <Link to="/" onClick={closeMobile}><Logo size="md" /></Link>
          <button
            type="button"
...
function BlogIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="currentColor">
      <path fillRule="evenodd" d="M4 4a2 2 0 012-2h8a2 2 0 012 2v12a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm3 3a1 1 0 011-1h4a1 1 0 110 2H8a1 1 0 01-1-1zm0 4a1 1 0 011-1h4a1 1 0 110 2H8a1 1 0 01-1-1zm0 4a1 1 0 011-1h2a1 1 0 110 2H8a1 1 0 01-1-1z" clipRule="evenodd"/>
    </svg>
  );
}
